...
{
    public static void AddAudio(Transform target, string clip, bool spatialBlend = false)
    {
    ...
    public static void AddAudio(Vector3 target, string clip, bool spantialBlend = false)
    {
